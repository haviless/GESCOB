...
// Objetivo : Mantenimiento de Reportes Semanales / Mensuales
// Actualizaciones:
...
type
  TFMantReportesSemanalesMensuales = class(TForm)
...
var
  FMantReportesSemanalesMensuales: TFMantReportesSemanalesMensuales;
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.FormShow(Sender: TObject);
begin
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.dbgUniversoCabRowChanged(
  Sender: TObject);
begin
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.FG_PINTAR_GRID_UNIVERSO_CAB();
var xsSQL : String;
...
begin
   ...
   xsSQL:='SELECT A.CODRPTUNICAB, A.ARCHIVO, A.FREG, NVL(B.CANT_REGISTROS, 0) CANT_REGISTROS '
        + '  FROM GES_RPT_UNIVERSO_CAB A, '
        + '       (SELECT CODRPTUNICAB, COUNT(1) CANT_REGISTROS '
        + '          FROM GES_RPT_UNIVERSO_DET '
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.FG_PINTAR_GRID_UNIVERSO_DET();
var xsSQL : String;
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.btnArchivoClick(Sender: TObject);
begin
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.btnValidarDatosClick(Sender: TObject);
begin
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.FG_CARGA_XLS(psArchivo : string);
var
  xnFila: Integer;
  xsFilaString: String;
  xxHoja: _WorkSheet;
...
begin
   ...
   xsSQL:='INSERT INTO GES_RPT_UNIVERSO_CAB(CODRPTUNICAB, ARCHIVO, FREG) '
  ...
  begin
      ...
      xsSQL := xsSQL
             + ' INSERT INTO GES_RPT_UNIVERSO_DET (CODRPTUNICAB, ASOID, ASOCODMOD, ASOAPENOM) '
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.btnSalirClick(Sender: TObject);
begin
  Close;
end;

(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.FormClose(Sender: TObject;
...
(******************************************************************************)
procedure TFMantReportesSemanalesMensuales.btnRetirarArchivoClick(
  Sender: TObject);
var xsSQL : string;
begin
  If MessageDlg('Confirma que desea Retirar el archivo : '
    ...
    xsSQL := ' BEGIN '
           + '    DELETE FROM GES_RPT_UNIVERSO_DET WHERE CODRPTUNICAB = ' + xxCdsQryUniversoCab.fieldbyname('CODRPTUNICAB').AsString + ';'
           + '    DELETE FROM GES_RPT_UNIVERSO_CAB WHERE CODRPTUNICAB = ' + xxCdsQryUniversoCab.fieldbyname('CODRPTUNICAB').AsString + ';'
           + '    COMMIT;'
