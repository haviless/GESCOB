object FrmImportarGestionesInt: TFrmImportarGestionesInt
  Left = 289
  Top = 219
  Width = 937
  Height = 518
  Caption = 'Importaci'#243'n de Gestiones Internas'
  Color = 10207162
    ...
    object Panel2: TPanel
      ...
      object lstValida: TListView
        ...
        Columns = <
          ...
          item
            Alignment = taCenter
            Caption = 'CODIGO GESTI'#211'N'
            Width = 80
          end
          item
            Alignment = taCenter
            Caption = 'FECHA GESTI'#211'N'
            Width = 80
          end
          item
            Caption = 'GESTI'#211'N'
          ...
          item
            Caption = 'CELULAR GESTI'#211'N'
            Width = 80
          end
          item
            Caption = 'FIJO GESTI'#211'N'
            Width = 80
          end
          item
            Caption = 'FECHA COMPROMISO GESTI'#211'N'
            Width = 80
          end
          item
            Caption = 'MONTO GESTI'#211'N'
            Width = 80
          end
          item
